...
BatchSize = 50 #The number of images used to calculate the gradients used to update the networks iteratively, should be shosen as large as possible give the memory constraints
...
def create_generator():
    ...
    generator.add(layers.Dense(int((image_Size/8)*(image_Size/8)*256), use_bias=False ,input_shape=(NoiseLength,),kernel_initializer='he_normal'))
    ...
    generator.add(layers.Conv2DTranspose(128, (4,4), strides=(2, 2), padding='same', use_bias=False,kernel_initializer='he_normal'))
    assert generator.output_shape == (None, int(image_Size/4), int(image_Size/4), 128)
    generator.add(layers.BatchNormalization())
    generator.add(layers.LeakyReLU(0.25))

    #generator.add(layers.Conv2DTranspose(96, (4,4), strides=(1, 1), padding='same', use_bias=False,kernel_initializer='he_normal'))
    #assert generator.output_shape == (None, int(image_Size/4), int(image_Size/4), 96)
    #generator.add(layers.BatchNormalization())
    #generator.add(layers.LeakyReLU(0.25))

    generator.add(layers.Conv2DTranspose(64, (4,4), strides=(2, 2), padding='same', use_bias=False,kernel_initializer='he_normal'))
    assert generator.output_shape == (None, int(image_Size/2), int(image_Size/2), 64)
    generator.add(layers.BatchNormalization())
    generator.add(layers.LeakyReLU(0.25))

    #generator.add(layers.Conv2DTranspose(48, (4,4), strides=(1, 1), padding='same', use_bias=False,kernel_initializer='he_normal'))
    #assert generator.output_shape == (None, int(image_Size/2), int(image_Size/2), 48)
    #generator.add(layers.BatchNormalization())
    #generator.add(layers.LeakyReLU(0.25))


    generator.add(layers.Conv2DTranspose(32, (4,4), strides=(2, 2), padding='same', use_bias=False,kernel_initializer='he_normal'))
    assert generator.output_shape == (None, int(image_Size), int(image_Size), 32)
    generator.add(layers.BatchNormalization())
    generator.add(layers.LeakyReLU(0.25))


    generator.add(layers.Conv2D(1, (2,2), strides=(1, 1), padding='same', use_bias=False, activation='linear',kernel_initializer='glorot_normal'))
...
def create_discriminator():
    ...
    disc.add(layers.Conv2D(32, (3,3), strides=(2, 2), padding='same',input_shape=[image_Size, image_Size, 1],kernel_initializer='he_normal'))
    ...
    #disc.add(layers.Conv2D(48, (4,4), strides=(1, 1), padding='same',kernel_initializer='he_normal'))
    #disc.add(layers.LeakyReLU(0.25))
    #disc.add(layers.SpatialDropout2D(0.4))

    disc.add(layers.Conv2D(64, (3,3), strides=(2, 2), padding='same',kernel_initializer='he_normal'))
    disc.add(layers.LeakyReLU(0.25))
    disc.add(layers.SpatialDropout2D(0.5))

    #disc.add(layers.Conv2D(96, (4,4), strides=(1, 1), padding='same',kernel_initializer='he_normal'))
    #disc.add(layers.LeakyReLU(0.25))
    #disc.add(layers.SpatialDropout2D(0.4))

    disc.add(layers.Conv2D(128, (3,3), strides=(2, 2), padding='same',kernel_initializer='he_normal'))
    disc.add(layers.LeakyReLU(0.25))
    disc.add(layers.SpatialDropout2D(0.5))
...
#prints a summary of the used networks
