...
def plot_generated_images2(epoch, generator,theOneNoiseVector,image_Size,pixelSize,save_dir):
    ...
    plt.figure()
    mapable = plt.imshow((generated_images[0]+1)/2,origin = 'lower',extent = [-image_Size*pixelSize/2,image_Size*pixelSize/2,-image_Size*pixelSize/2,image_Size*pixelSize/2],cmap='hot')#,vmin= 0,vmax =1)
...
class framework:
    ...
    def SingleRun(self,Generator, discriminator,opt,dataLikelihood , pixelSize ,epochs = 250,image_Size = 128,hyperParam = 2,NoiseLength = 100,saveDir  = '',plotAtEpoch = [],loud = False,Dir =None):
        ...
        #        layer.trainable = True
        Generator.trainable = True
        #for layer in Generator.layers: #change to generator
        #        if layer.__class__.__name__ == 'BatchNormalization':
        #            layer.trainable = False
        #            print('!!!!!!!!!!!!!!!!jup, set to false!!!!!!!!!!!!!')
        #            break
                #!!!!!!!!!!!!!! remove!!!!!!!!!!!!!
